...
static char input2[64];
static int page = 0;
static float tab_alpha = 0.f; /* */ static float tab_add; /* */ static int active_tab = 0;

static float tab_alphas = 0.f; /* */ static float tab_adds; /* */ static int active_tabs = 0;
...
static const char* items1[5]{ "Weapon", "Deagle", "M4A1", "MAC10", "UZI" };
