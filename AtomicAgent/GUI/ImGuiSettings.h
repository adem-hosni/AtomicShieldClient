...
namespace c
{
    ...
    inline ImVec4 line_bg = ImColor(29, 30, 40, 255);
    ...
    inline ImVec4 text_button = ImColor(73, 72, 89, 205);

    inline ImVec4 text_blue = ImColor(180, 218, 255, 255);
    inline ImVec4 text_blue_1 = ImColor(180, 218, 255, 105);
    inline ImVec4 bg_icon_button = ImColor(24, 23, 36, 255);

    inline ImVec4 button_multi_1 = ImColor(102, 179, 255, 255);
    inline ImVec4 button_multi_2 = ImColor(188, 226, 255, 255);

    inline ImVec4 shadow_button = ImColor(77, 169, 255, 205);

    inline ImVec4 bg_circle = ImColor(255, 255, 255, 14);

    inline ImVec4 bg_icon_profile = ImColor(255, 255, 255, 5);

    inline ImVec4 rect_icon_profile = ImColor(180, 218, 255, 20);
}            // namespace c
