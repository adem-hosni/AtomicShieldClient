...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     510
...
//#endif
	...
	IMGUI_API bool          ButtonInfo(const char* label, const char* text, ImTextureID image, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
	...
	IMGUI_API bool          InputTextEx_1(const char* label, ImTextureID image, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
