...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonText(const char* label, ImColor ColorText, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Keybind(const char* label, const char* text, int* key, int* mode, bool label_active = true);
    IMGUI_API bool          Checkboxx(const char* label, bool* v);
	IMGUI_API bool          checkboxP(const char* label, bool* v, const ImVec2& size_arg);
    IMGUI_API void          esp_preview(ImTextureID player_preview, bool* nickname, float nick_color[4], bool* weapon, float weapon_color[4], int* hp, float hp_color[4], bool* zoom, float zoom_color[4], bool* bomb, float bomb_color[4], bool* c4, float c4_color[4], bool* money, float money_color[4], bool* hit, float hit_color[4], bool* esp_box, float box_color[4], bool* hp_line, float hp_line_color[4]);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* text, const char* label_1, ImTextureID image, ImTextureID image_1, const char* preview_value, float val, float width, bool multi = 0, ImGuiComboFlags flags = 0);
  //  IMGUI_API void		    MultiCombo(const char* label, const char* description, ImTextureID image, bool variable[], const char* labels[], int count);
    IMGUI_API void          EndCombo(); // only call EndCombo() if BeginCombo() returns true!
    IMGUI_API bool          Combo(const char* label, const char* text, const char* label_1, ImTextureID image, ImTextureID image_1, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items = -1, float width = 180);
    IMGUI_API bool          Combo(const char* label, const char* text, const char* label_1, ImTextureID image, ImTextureID image_1, int* current_item, const char* const items[], int items_count, int height_in_items, float width);
    IMGUI_API bool          Combo(const char* label, const char* text, const char* label_1, ImTextureID image, ImTextureID image_1, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1);
    ...
    IMGUI_API bool          SliderInt_Custom(const char* label, const char* text, const char* label_1, const char* texts, ImTextureID image, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar_Custom(const char* label, const char* text, const char* label_1, const char* texts, ImTextureID image, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          ColorEdit3(const char* label, const char* text, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, const char* text, float col[4], ImGuiColorEditFlags flags = 0);
...
enum ImGuiCol_
{
    ...
    ImGuiCol_PopupBg_1,               // Background of popups, menus, tooltips windows
    ImGuiCol_Border,
