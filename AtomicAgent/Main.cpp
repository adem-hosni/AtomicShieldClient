...
void ApiChecks(LPVOID lpThreadParameter)
{
    ...
    else
    {
        ...
        else
        {
            ...
            result->strMessage = skCrypt("This version of Latinos is no longer supported. Please update to the latest version to continue.");
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR pCmdLine, int nCmdShow)
{
    ...
    SharedUtil::AddDebugLog(skCrypt("Latinos Agent started with command line: %s"), cmdLine.c_str());
