...
bool ManualMapDll(HANDLE hProc, BYTE* pSrcData, SIZE_T FileSize, bool ClearHeader = true, bool ClearNonNeededSections = true, bool AdjustProtections = true,
                  ...
                  bool SEHExceptionSupport, DWORD fdwReason, LPVOID lpReserved)
{
    ...
    ILog("Target point %p", pShellcode);
    system("pause");
#endif
    ...
    ILog("Thread created at: %p, waiting for return...", pShellcode);
