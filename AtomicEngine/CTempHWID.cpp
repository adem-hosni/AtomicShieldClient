...
jsoncons::json CTempHWID::GetExtraData()
{
...
jsoncons::json CTempHWID::GetMonitorSerial()
{
    return jsoncons::json::array();
}

std::string CTempHWID::GetWindowsUsername()
{
...
std::string CTempHWID::GetSteamID()
{
    HKEY           hKey = nullptr;
...
std::string CTempHWID::GetMotherBoardSerial()
{
    HRESULT hr;
...
jsoncons::json CTempHWID::GetDisksSerialNumber()
{
    // Get logical drives
...
std::string CTempHWID::GetCPUsSerials()
{
    HRESULT hres;
...
std::string CTempHWID::GetBIOSVersion()
{
    HRESULT hr;
...
std::string CTempHWID::GetPNPDeviceID()
{
    HRESULT hres;
...
std::string CTempHWID::GetComputerName_()
{
...
void CTempHWID::StoreHWIDCaches(jsoncons::json hwid)
{
    PWSTR path = nullptr;
...
jsoncons::json CTempHWID::LoadHWIDCaches()
{
    jsoncons::json json;
...
bool CTempHWID::WriteADS(std::string strPath, std::string strStreamName, std::string strData)
{
    if (strPath.empty())
        return false;
...
std::string CTempHWID::ReadADS(std::string strPath, std::string strStreamName)
{
    if (strPath.empty())
        return "";
