...
{
    std::vector<std::string> vBlacklistedDrivers = {std::string(skCrypt("ntguard.sys")),
                                                    std::string(skCrypt("BEDaisy.sys")),
                                                    std::string(skCrypt("Gdrv.sys")),
                                                    std::string(skCrypt("AsIO.sys")),
                                                    std::string(skCrypt("AsUpIO.sys")),
                                                    std::string(skCrypt("CPUID.sys")),
                                                    std::string(skCrypt("ENE.sys")),
                                                    std::string(skCrypt("iqvw64e.sys")),
                                                    std::string(skCrypt("hxctl.sys")),
                                                    std::string(skCrypt("kprocesshacker.sys")),
                                                    std::string(skCrypt("kprocesshacker2.sys")),
                                                    std::string(skCrypt("EIO64.sys")),
                                                    std::string(skCrypt("IOMap64.sys")),
                                                    std::string(skCrypt("ATSZIO64.sys")),
                                                    std::string(skCrypt("atillk64.sys")),
                                                    std::string(skCrypt("aswVmm.sys")),
                                                    std::string(skCrypt("BS_Flash64.sys")),
                                                    std::string(skCrypt("Capcom.sys")),
                                                    std::string(skCrypt("cpuz141.sys")),
                                                    std::string(skCrypt("WinRing0x64.sys")),
                                                    std::string(skCrypt("FairplayKD.sys")),
                                                    std::string(skCrypt("pgldqpoc.sys")),
                                                    std::string(skCrypt("HwOs2Ec10x64.sys")),
                                                    std::string(skCrypt("Phymemx64.sys")),
                                                    std::string(skCrypt("Monitor_win10_x64.sys")),
                                                    std::string(skCrypt("driver.sys")),
                                                    std::string(skCrypt("lha.sys")),
                                                    std::string(skCrypt("Mslo64.sys")),
                                                    std::string(skCrypt("NTIOLib_x64.sys")),
                                                    std::string(skCrypt("pcdsrvc_x64.pkms")),
                                                    std::string(skCrypt("HWiNFO64A.sys")),
                                                    std::string(skCrypt("rzpnk.sys")),
                                                    std::string(skCrypt("magdrvamd64.sys")),
                                                    std::string(skCrypt("speedfan.sys")),
